...
namespace bridge {
    PX4_ZED_Bridge::PX4_ZED_Bridge(const ros::NodeHandle& nh) : nh_(nh) {
        odom_sub_ = nh_.subscribe<const geometry_msgs::PoseWithCovarianceStamped&>("/zedm/zed_node/pose_with_covariance", 10, &PX4_ZED_Bridge::odomCallback, this);
    ...
    void PX4_ZED_Bridge::odomCallback(const geometry_msgs::PoseWithCovarianceStamped& msg) {
